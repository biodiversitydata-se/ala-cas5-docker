...
URL_CAS5 = https://github.com/bioatlas/ala-cas-5/releases/download/BAS-5.3.12-2/cas-exec.war
...
URL_USERDETAILS = https://nexus.ala.org.au/service/local/repositories/releases/content/au/org/ala/userdetails/2.3.0/userdetails-2.3.0.war
...
init:
	...
	@test -f userdetails/userdetails-2.3.0.war || \
		wget -q --show-progress -O userdetails/userdetails-2.3.0.war $(URL_USERDETAILS)
